...
import (
	...
	"github.com/Lucasvmarangoni/video-encoder/framework/queue"
...
func main() {
	...
	jobRetunChannel := make(chan services.JobWorkerResult)
	...
	jobManager := services.NewJobManager(dbConnection, rabbitMQ, jobRetunChannel, messageChannel)
	jobManager.Start(ch)
}
